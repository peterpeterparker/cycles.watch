...
export const AUTH_MAX_TIME_TO_LIVE_IN_MILLISECONDS = 14 * 24 * 60 * 60 * 1000;
export const AUTH_MAX_TIME_TO_LIVE_IN_NANOSECONDS = BigInt(
	AUTH_MAX_TIME_TO_LIVE_IN_MILLISECONDS * 1000 * 1000
);
