<script lang="ts">
  import type {Canister, CanisterCyclesStatus, CanisterData} from '../../types/canister';
  ...
  import CanisterSkeleton from '../ui/CanisterSkeleton.svelte';
  import CanisterInfo from '../ui/CanisterInfo.svelte';
  ...
  $: ({id, data, status: syncStatus} = canister);
...
<article class:warn={cyclesStatus === 'warn'} class:error={cyclesStatus === 'error'}>
